// VibeCoder Studio — Production Prompt Templates
// Each template maps to a module in the PRD's lifecycle system.
// The [PLACEHOLDER] sections are replaced dynamically with Smart Form answers.
// Design Passport and Context Chain are injected during assembly (see promptEngine.ts).
...
// Platform-specific text substitutions for mobile prompt adaptation
export const PLATFORM_SUBSTITUTIONS: Record<string, string> = {
